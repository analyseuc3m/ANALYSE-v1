...
from data import get_courses_list, get_course_key, get_course_module
...
def update_DB_analytics():
	...
	for course_id in course_ids:
		course_url = get_course_module(course_id)
		if not str(course_id) ==  "course-v1:edX+DemoX+Demo_Course":
